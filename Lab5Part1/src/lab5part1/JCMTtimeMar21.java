...
public class JCMTtimeMar21 
{
     ...
     * @param minute 
     */
    public JCMTtimeMar21(int year, int month, int dayOfMonth, int hourInMil, int minute)
    {
     ...
     * @param second 
     */
    public JCMTtimeMar21(int year, int month, int dayOfMonth, int hourInMil, int minute, int second)
    {
        this.LOG.info("Constructor with inputs");
        setYear(year);
        setMonth(month);  // sets month name too
     ...
     * @param dayOfMonth 
     */
    public JCMTtimeMar21(int year, int month, int dayOfMonth)
    {
        setYear(year);
        setMonth(month);  // sets month name too
        setDayOfMonth(dayOfMonth);
